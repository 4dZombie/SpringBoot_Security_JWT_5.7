...
public class UserRegisterDTO extends ExtendedDTO {
  ...
  public UserRegisterDTO(UUID id, String firstName, String lastName, String email, String password, String street, Date birthdate, DistrictDTO district, RankDTO rank, Boolean kids, Boolean student, int employment) {
    super(id);
