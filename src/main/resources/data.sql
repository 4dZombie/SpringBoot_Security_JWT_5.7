...
VALUES ('ab70853a-20f3-4683-919d-cf59cfeac480', 'Lausanne', 1000);
INSERT INTO districts (id, name, plz)
VALUES ('726753a1-ce7c-4dd5-9a84-5032e9d531e6', 'Neuchatel', 2000);
INSERT INTO districts (id, name, plz)
VALUES ('11b41514-c396-4f47-a65c-4cf65cedf466', 'Bern', 3000);
INSERT INTO districts (id, name, plz)
VALUES ('e738e1ce-cf48-407c-af80-4d1c3ceb78f1', 'Basel', 4000);
INSERT INTO districts (id, name, plz)
VALUES ('a9a29b19-92ff-4d1d-83a0-c211f97e4e41', 'Aarau', 5000);
INSERT INTO districts (id, name, plz)
VALUES ('fe90bbab-8734-4394-bc75-13c0314edc7d', 'Luzern', 6000);
INSERT INTO districts (id, name, plz)
VALUES ('4cad858c-6fdd-472e-b7dd-4fa0899401d8', 'Chur', 7000);
INSERT INTO districts (id, name, plz)
VALUES ('8e3a5af7-d4dc-4981-b0b7-1540b764648a', 'Zürich', 8000);
INSERT INTO districts (id, name, plz)
VALUES ('38646941-79fe-4064-99b4-8d4b18987ba4', 'St. Gallen', 9000);

INSERT INTO users (id, first_name, last_name, birthdate, email, password, street, kids, student, employment,
                   district_id, rank_id, created_at, created_by, modified_at, last_modified_by)
VALUES ('17b49eee-4726-428b-8b27-722d30906f9c', 'Test', 'Surename', '2000-12-20', 'test@test.ch',
        ...
        '17b49eee-4726-428b-8b27-722d30906f9c', '2000-12-20', '17b49eee-4726-428b-8b27-722d30906f9c');
